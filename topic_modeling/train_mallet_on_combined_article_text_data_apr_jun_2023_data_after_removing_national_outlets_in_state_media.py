"""
This code borrows trains MALLET topic model(s) on combined article text data -- AFTER FILTERING OUT NATIONAL OUTLETS IN STATE MEDIA, saving all the outputs of the model, and also adding the topic probabilities to the combined data file. And saving the url to topic distribution mapping itself. Topics themselves will be interpreted and displayed (in terms of top words and top documents) in a separate notebook. 
...
INPUT_DEDUP_FILES_BASE_PATH = (
    "/home/pranavgoel/trans-fer-entropy/national_outlet_filtering_in_state_collections/data_with_national_outlets_removed_in_state_collections/"
)

OUTPUT_COMBINED_DATAFILE_PATH = (
    "/home/pranavgoel/trans-fer-entropy/topic_modeling/prior_data_apr_jun_2023/all_texts_combined_post_filtering_national_outlets_in_state_media.csv"
)
...
MALLET_OUTPUT_PATH = (
    "/home/pranavgoel/mallet_output/trans_fer_entropy_apr_jun_2023_post_filtering_national_outlets_in_state_media"
)

OUTPUT_DATA_WITH_TOPIC_DISTRIBUTION_BASEPATH = (
    "/home/pranavgoel/trans-fer-entropy/topic_modeling/prior_data_apr_jun_2023_filtering_national_outlets_in_state_media/"
)
